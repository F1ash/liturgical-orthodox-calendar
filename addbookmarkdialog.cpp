    ...
    : QDialog(parent)
{
    ...
    bookmarkNameEdit->setToolTip(
                QString::fromUtf8("Введите название новой закладки"));
    myLayout = new QVBoxLayout(this);
    ok = new QPushButton(QIcon::fromTheme("dialog-ok"),
                         QString::fromUtf8("OK"), this);
    cancel = new QPushButton(QIcon::fromTheme("dialog-cancel"),
                             QString::fromUtf8("Отмена"), this);
