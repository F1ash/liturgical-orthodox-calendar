...
void ToolBar::initActions()
{
    ...
    connect(_clearHistoryAction, SIGNAL(triggered()),
            this, SLOT(clearHistoryAction()));
...
void ToolBar::addToolButton()
{
    ...
    connect(bookmarkButton, SIGNAL(clicked(bool)),
            bookmarkButton, SLOT(showMenu()));
    ...
    connect(bookmarkMenu, SIGNAL(customContextMenuRequested(QPoint)),
...
void ToolBar::addHistoryToolButton()
{
    ...
    connect(historyButton, SIGNAL(clicked(bool)),
            historyButton, SLOT(showMenu()));
    ...
    connect(historyMenu, SIGNAL(customContextMenuRequested(QPoint)),
            this, SLOT(showHistoryMenu(QPoint)));
